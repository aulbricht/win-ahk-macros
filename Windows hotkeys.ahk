...
; Open Cortana: alt + space
!space::
	WinActivate, Program Manager ; remove focus from whatever app currently has it
	SendEvent #s
	return

; Open Snipping Tool: ctrl + alt + 4
^!4::
...
; Alt-Drag Window: alt + left-mouse button
Alt & LButton::
